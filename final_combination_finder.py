#!/usr/bin/env python3
"""
Final Combination Finder with Ranking
Finds all combinations and ranks them by best evaluation
"""
...
def main():
    exercises = [
        (3, "W:Wa1,g1,b2,c3,b4,h4:Bd4,a5,e5,f6,g7,f8", 7),
        (4, "W:Wa1,g1,b2,f2,c3,h4:Bd4,a5,e5,d6,f6,e7", 9),
    ]

    for number, fen, depth in exercises:
        print("=" * 70)
        ...
        print(f"\nTop 5 best combinations (by evaluation):\n")
